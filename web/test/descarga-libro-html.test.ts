...
import { GET } from '../src/app/api/descarga/libro-html/route';
...
function fakeRequest(): never {
  return { nextUrl: new URL('http://localhost/api/descarga/libro-html?narrador=n1') } as never;
}
...
describe('GET /api/descarga/libro-html', () => {
