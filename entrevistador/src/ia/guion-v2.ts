...
export const GUION: readonly Fila[] = [
  ...
  { id: 'por-gusto', etapa: 'adultez media', tramo: null, aplica: S, tema: 'Lo que hacía por gusto, cuando nadie se lo pedía: lo que ya nombró. Si no nombró nada, preguntá abierto, sin ofrecerle opciones ni ejemplos: que lo diga con sus palabras.', pormenores: ['qué hacía por gusto', 'con quién'] },
  ...
  // Futuro
  { id: 'lo-que-te-queda-por-hacer', etapa: 'futuro', tramo: null, inamovible: true, aplica: S, tema: 'Lo que quiere para su vida de acá en adelante: sueños, planes, lo que le queda por ver. A los veinte es la mitad del libro; a los ochenta es "qué le queda por hacer y qué ya no".', pormenores: ['qué le queda por hacer', 'con quién', 'qué le falta para que pase'] },
