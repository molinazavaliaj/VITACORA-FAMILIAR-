...
| **Mié 23** | 2.10 todos los productos en el carrito · pasar los cambios de texto de Naza al panel de viaje | Revisión de textos del panel de viaje (`viaje.tsx`, `angulos.tsx`) |
