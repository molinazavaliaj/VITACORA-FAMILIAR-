...
7. **Piso 600, no 800:** con 800 su libro daba 4 capítulos (lo que no le gustó de la v4). A confirmar con otro narrador. Ya resuelto: piso proporcional, 7 % entre 600 y 900 (Fable, 26/09; su libro da 600).
...
**Conclusión:** el "formulario" viene del material, no del escritor. Una pregunta que pide describir ("¿cómo es ella?") da una ficha, y el escritor no puede hacerla escena sin inventar. Una pregunta que pide un momento da una escena en menos de un minuto de audio. El arreglo va en la **entrevista**: preguntas de momentos en el banco y una repregunta fija ("¿Te acordás de una vez concreta? Contame ese día") cuando la respuesta sale resumen. (Actualizado el 26/09 con Fable: la repregunta fija quedó descartada. Queda la regla de momentos (D7 del diseño) para el banco y el cazador de escenas al cerrar cada bloque ([`cazador-de-escenas.md`](cazador-de-escenas.md)): un modelo elige una respuesta y el narrador recibe "Me contaste esto: «…». ¿Te acordás de una vez concreta?…".) El escritor se queda con la regla de contar una historia (ayuda, no alcanza).
